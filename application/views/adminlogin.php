...
<!-- iCheck -->
 ...
 <!--[if lt IE 9]>
  ...
  <a href="../../index2.html"><b>Fronthotels Admin Login</b><!--LTE--></a>
      </div><div class="row">
		<div class="col-xs-12">
			<?php
      ...
      <div class="login-box-body">
        ...
        <?php echo form_open('dashboard/adminlogin');?>
        <!-- <form action="<?php echo base_url('dashboard/login');?>" method="post"> -->
        <?php echo form_hidden(['name'=>'userole','value'=>'1']);?>
   ...
   <span class="glyphicon glyphicon-lock form-control-feedback"></span>
     ...
     <a href="<?php echo base_url('dashboard/propertyOregister');?>" class="text-center">Create an new account</a>
