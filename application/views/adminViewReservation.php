...
<?php echo form_open_multipart('dashboard/adminSendReservation');?>
<?php $data = array('propertyName'=>$posts->propertyName,'property_id'=>$posts->property_id,'propertyOwnerid'=>$posts->propertyOwnerid,
'roomName'=>$posts->roomName,
'roomType'=>$posts->roomType,'customer_name'=>$posts->customer_name,'checkin'=>$posts->checkin,'checkout'=>$posts->checkout,'GrandTotal'=>$posts->GrandTotal,
 'msg'=>"Dear partner  
...
<fieldset>
<table>
<tr><th><b>Hotel Name:</b></th><th><b>Customer Name:</b></th><th><b>Email address:</b></th>
<th><b>Contact Number:</b></th><th>Room type</th><th>Number of rooms</th><th><b>Checkin: </b></th><th><b>Check out:</b></th><th><b>Total Amount:</b></th><th></th></tr>
<tr><td><?php echo $posts->propertyName;?></td><td>
<?php echo $posts->customer_name;?></td><td>
<?php echo $posts->customer_email;?></td><td>
<?php echo $posts->customer_contact;?></td><td>
<?php echo $posts->roomType;?></td>
<td>
<?php echo $posts->no_of_rooms;?></td>
<td>
<?php echo $posts->checkin;?></td><td>
<?php echo $posts->checkout;?></td><td>
<?php echo $posts->GrandTotal;?></td><td>
<input type='submit' value='Forward reservation' class='hollow button success'>
<!--<?php echo form_submit(['name'=>'submit','value'=>'Forward reservation','class'=>'hollow button success']);?>-->
</td></tr></table>
</h1>
</fieldset>
<?php echo form_close();?>
