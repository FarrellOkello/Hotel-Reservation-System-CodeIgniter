...
<!-- iCheck -->
 ...
 <!--[if lt IE 9]>
  ...
  <a href="../../index2.html"><b>Fronthotels Property Owner</b><!--LTE--></a>
      </div><!-- /.login-logo -->
...
<div class="row">
        ...
        <?php echo form_open('dashboard/propertyOlogin');?>
   ...
   <span class="glyphicon glyphicon-lock form-control-feedback"></span>
     ...
     <a href="<?php echo base_url('dashboard/registerproperty');?>" class="text-center">Create an new account</a>
