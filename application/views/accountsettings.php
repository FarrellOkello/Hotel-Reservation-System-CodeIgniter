...
<h3>Account
change password</h3>
<?php echo form_open_multipart('dashboard/change_pass');?>
<div class="row">
		<div class="col-xs-12">
			<?php
	...
	<input type="password" class="form-control" id="email" name="old_pass" value="" required="required">
</div>
<div class="form-group">
<label for="password">New Password:</label>
<input type="password" class="form-control" id="password" name="new_pass" value="" required="required">
</div>
<div class="form-group">
<label for="password_confirm">Repeat Password:</label>
<input type="password" class="form-control" id="password_confirm" name="confirm_pass" value="" required="required">
</div>
