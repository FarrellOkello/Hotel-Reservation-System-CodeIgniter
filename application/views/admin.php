	...
	<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              <ul class="nav navbar-nav">
				...
				<li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url('dashboard/managePublished');?>">Manage Published</a></li>
					<li class="divider"></li>
                    ...
                    <li><a href="#">One more separated link</a></li> -->
								...
								<li class="dropdown">
                  <a href="<?php echo base_url('dashboard/adminmail');?>">Mail</a>
				...
				<li class="dropdown">
                  ...
                  <!-- <li><a href="propertyOsignin">login</a></li>
					...
					<li class="divider"></li>
                    <li><a href="<?php echo base_url('dashboard/adminlogout');?>">Logout</a></li>
                    <li class="divider"></li>
                   </ul>
                </li>
              </ul>
...
<div>
<table>
<tr><th>Hotel</th><th>Customer Name</th><th>Contact no</th><th>Email</th><th>Room type</th><th>Number of rooms</th>
...
<td><?php echo $Precord->roomType;?></td>

<td><?php echo $Precord->no_of_rooms?></td>
  <td><p><?php echo $Precord->checkin?></td><td><?php echo $Precord->checkout?></p></td>
  <td><?php echo $Precord->GrandTotal?></td> 
  <td><?php echo anchor("dashboard/adminViewReservation/{$Precord->book_id}","View",['class'=>'button']);?>|,
<!--<?php echo anchor("dashboard/post/{$Precord->book_id}","Publish",['class'=>'button']);?>|-->
  <?php echo anchor("dashboard/adminDeleteReservation/{$Precord->book_id}","Delete",['class'=>'button']);?></td></tr>
</div>
<div>
<?php endforeach;?>
<?php else:?>
...
<?php endif;?>
    ...
    <fieldset><label><h3>Properties</h3></label>
<!-- <a href="registerProperty" class="button">Add Property</a>-->
<hr/>
<div>
<div>
 <table> 
 <tr><th>Property</th><th>Details</th><th></th></tr>
 <?php if(count($records)):?>
<?php foreach($records as $record):?>
<tr><td><?php echo $record->propertyName;?></td><th></th><th></th></tr>
  <tr><td><img src=<?php echo $record->img;?> height=100 width= 100></td>
  <td><p>Ranking*<?php echo $record->hotel_grade?><br><?php echo $record->description?></p></td>
  <td><?php echo anchor("dashboard/adminViewProperty/{$record->Property_id}","View",['class'=>'button']);?>|
  <?php echo anchor("dashboard/adminEditProperty/{$record->Property_id}","Edit",['class'=>'button']);?>|
  <?php echo anchor("dashboard/adminDeleteProperty/{$record->Property_id}","Delete",['class'=>'button']);?>
  </td></tr>
</div>
<div>
<?php endforeach;?>
