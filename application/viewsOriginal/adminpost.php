...
<div class="row">
<div >
<table><tr><th><?php echo $posts->propertyName;?></th><th></th></tr>
<tr><td><img src="<?php echo $posts->img;?>" width ='200' height='300'></td>
...
<?php echo form_submit(['name'=>'submit','value'=>'Publish Property','class'=>'hollow button success']);?>
<?php echo form_close();?>
