	...
	<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              ...
              <li class="dropdown">
                ...
                <li class="dropdown">           
                 ...
                 <li class="dropdown">
                  <a href="<?php echo base_url('index.php/dashboard/reservation');?>">Reservations</a>
...
<table>
<tr><th>Customer name</th><th>Contact</th><th>email</th>
<th>check in</th><th>check out</th><th>No of Rooms</th>
<th>Room Type</th><th>Total Amount</th><th></th><th></th></tr>
<?php if(count($reservations)):?>
<?php foreach($reservations as $reservation):?>
  <tr><td><?php echo $reservation->customer_name;?></td>
  <td><?php echo $reservation->customer_contact;?>
  </td><td><?php echo $reservation->customer_email;?></td>
  <td><?php echo $reservation->checkin;?></td><td><?php echo $reservation->checkout;?></td>
  <td><?php echo $reservation->no_of_rooms;?></td><td><?php echo $reservation->roomType;?></td><td>
  <?php echo $reservation->GrandTotal;?></td><td></td>
  <td><?php echo anchor("dashboard/viewReservation/{$reservation->book_id}","View",['class'=>'btn btn-primary btn-block btn-flat']);?>
  <!-- <?php echo anchor("dashboard/editpost/{$reservation->book_id}","Edit",['class'=>'button']);?>| -->
  <!-- <?php echo anchor("dashboard/deletePost/{$reservation->book_id}","Delete",['class'=>'button']);?></td> -->
  </tr> 
<!-- </div>
</div> -->
<?php endforeach;?>
<?php else:?>
<p>Sorry you dont have any reservations today!
<?php endif;?>
	</div><p>
    </table>
<!-- <ul>
